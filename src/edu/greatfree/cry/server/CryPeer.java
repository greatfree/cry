 ...
 * 04/28/2022
 * 
 * Since ServerMessage is needed in clustering APIs, it is necessary to use ServerDispatcher rather than encapsulating it. The previous version, Peer, makes it invisible. The new class replaces it. 04/28/2022, Bing Li
 *
 */
// public final class CryPeer<Dispatcher extends CryptoCSDispatcher>
public final class CryPeer<Dispatcher extends ServerDispatcher<ServerMessage>>
{
	private final static Logger log = Logger.getLogger("edu.greatfree.cry.server");

	private org.greatfree.server.container.Peer<Dispatcher> peer;
...
//	private SymmetricCrypto symCrypto;
	...
	public CryPeer(CryPeerBuilder<Dispatcher> builder) throws IOException, NoSuchAlgorithmException
	{
//		log.info("CryPeer is initialized ...");
...
//			log.info("1) Peer is initialized ...");
			...
			this.peer = new org.greatfree.server.container.Peer.PeerBuilder<Dispatcher>()
...
//		log.info("dispatcher server key = " + builder.getDispatcher().getServerKey());
...
//			ServiceProvider.CRY().init(this.peer.getPeerName(), csd.getServerKey(), builder.getTask(), AsymmetricCoder.generateCrypto(builder.getAsymCipherAlgorithm(), builder.getAsymCipherKeyLength(), builder.getSymCipherAlgorithm(), builder.getSymCipherSpec(), builder.getSymCipherKeyLength(), builder.getSymIVKeyLength(), builder.getSignatureAlgorithm(), builder.getSignature()));
			ServiceProvider.CRY().init(this.peer.getPeerName(), builder.getDispatcher().getServerKey(), builder.getTask(), AsymmetricCoder.generateCrypto(builder.getAsymCipherAlgorithm(), builder.getAsymCipherKeyLength(), builder.getSymCipherAlgorithm(), builder.getSymCipherSpec(), builder.getSymCipherKeyLength(), builder.getSymIVKeyLength(), builder.getSignatureAlgorithm(), builder.getSignature()));
		}
		else
		{
//			ServiceProvider.CRY().init(this.peer.getPeerName(), csd.getServerKey(), builder.getTask(), AsymmetricCoder.generateCrypto(builder.getAsymCipherAlgorithm(), builder.getAsymCipherKeyLength(), builder.getSymCipherAlgorithm(), builder.getSymCipherSpec(), builder.getSymCipherKeyLength(), builder.getSymIVKeyLength()));
			ServiceProvider.CRY().init(this.peer.getPeerName(), builder.getDispatcher().getServerKey(), builder.getTask(), AsymmetricCoder.generateCrypto(builder.getAsymCipherAlgorithm(), builder.getAsymCipherKeyLength(), builder.getSymCipherAlgorithm(), builder.getSymCipherSpec(), builder.getSymCipherKeyLength(), builder.getSymIVKeyLength()));
		}
...
//	public static class CryPeerBuilder<Dispatcher extends CryptoCSDispatcher> implements Builder<CryPeer<Dispatcher>>
	public static class CryPeerBuilder<Dispatcher extends ServerDispatcher<ServerMessage>> implements Builder<CryPeer<Dispatcher>>
	{
		/*
...
//		private String dsaAlgorithm;
		...
		public CryPeerBuilder()
		{
		}
		
		public CryPeerBuilder<Dispatcher> peerName(String peerName)
		{
			this.peerName = peerName;
			return this;
		}
		
		public CryPeerBuilder<Dispatcher> port(int port)
		{
			this.port = port;
			return this;
		}
		
		public CryPeerBuilder<Dispatcher> registryServerIP(String registryServerIP)
		{
			this.registryServerIP = registryServerIP;
			return this;
		}
		
		public CryPeerBuilder<Dispatcher> registryServerPort(int registryServerPort)
		{
			this.registryServerPort = registryServerPort;
			return this;
		}

//		public PeerBuilder<Dispatcher> task(MulticastTask task)
		public CryPeerBuilder<Dispatcher> task(ServerTask task)
		{
			this.task = task;
			return this;
		}
		
		public CryPeerBuilder<Dispatcher> isRegistryNeeded(boolean isRegistryNeeded)
		{
			this.isRegistryNeeded = isRegistryNeeded;
			return this;
		}
		
		public CryPeerBuilder<Dispatcher> dispatcher(Dispatcher dispatcher)
		{
		...
		*/
		...
		public CryPeerBuilder<Dispatcher> isEncrypted(boolean isEncrypted)
		{
			this.isEncrypted = isEncrypted;
			return this;
		}

		public CryPeerBuilder<Dispatcher> isAsymCryptography(boolean isAsymCryptography)
		{
			this.isAsymCryptography = isAsymCryptography;
			return this;
		}

		public CryPeerBuilder<Dispatcher> symCipherAlgorithm(String symCipherAlgorithm)
		{
			this.symCipherAlgorithm = symCipherAlgorithm;
			return this;
		}

		public CryPeerBuilder<Dispatcher> symCipherSpec(String symCipherSpec)
		{
			this.symCipherSpec = symCipherSpec;
			return this;
		}

		public CryPeerBuilder<Dispatcher> symCipherKeyLength(int symCipherKeyLength)
		{
			this.symCipherKeyLength = symCipherKeyLength;
			return this;
		}

		public CryPeerBuilder<Dispatcher> symIVKeyLength(int symIVKeyLength)
		{
			this.symIVKeyLength = symIVKeyLength;
			return this;
		}

		public CryPeerBuilder<Dispatcher> asymCipherAlgorithm(String asymCipherAlgorithm)
		{
			this.asymCipherAlgorithm = asymCipherAlgorithm;
			return this;
		}
		
		public CryPeerBuilder<Dispatcher> asymCipherKeyLength(int asymCipherKeyLength)
		{
			this.asymCipherKeyLength = asymCipherKeyLength;
			return this;
		}

		public CryPeerBuilder<Dispatcher> signatureAlgorithm(String signatureAlgorithm)
		{
			this.signatureAlgorithm = signatureAlgorithm;
			return this;
		}
		
		public CryPeerBuilder<Dispatcher> signature(String signature)
		{
			this.signature = signature;
			return this;
		}

		public CryPeerBuilder<Dispatcher> isPrivate(boolean isPrivate)
		{
			this.isPrivate = isPrivate;
			return this;
		}

		public CryPeerBuilder<Dispatcher> ownersSize(int ownersSize)
		{
			this.ownersSize = ownersSize;
			return this;
		}

		public CryPeerBuilder<Dispatcher> configXML(String configXML)
		{
		...
		@Override
		public CryPeer<Dispatcher> build() throws IOException
		{
			try
			{
				return new CryPeer<Dispatcher>(this);
			}
...
//		public MulticastTask getTask()
	...
	public void stop(long timeout) throws RemoteIPNotExistedException, ClassNotFoundException, RemoteReadException, InterruptedException, IOException, PeerNameIsNullException
	{
...
//				this.syncNotifyAsymmetrically(entry, new SayAsymmetricByeNotification(this.peer.getPeerName(), this.peer.getPeerID(), ServiceProvider.CRY().getAsymmetricSessionKey(), ServiceProvider.CRY().getSignature()));
				try
				{
					this.syncAsymBye(entry, new AsymmetricBye(this.peer.getPeerName(), this.peer.getPeerID(), ServiceProvider.CRY().getAsymmetricSessionKey(), ServiceProvider.CRY().getSignature()));
				}
...
//				this.syncNotifySymmetrically(entry, new SaySymmetricByeNotification(this.peer.getPeerName(), this.peer.getPeerID()));
				try
				{
					this.syncSymBye(entry, new SymmetricBye(this.peer.getPeerName(), this.peer.getPeerID()));
				}
				catch (InvalidKeyException | ClassNotFoundException | NoSuchAlgorithmException | NoSuchPaddingException
						| InvalidAlgorithmParameterException | IllegalBlockSizeException | BadPaddingException
						| RemoteReadException | IOException | InterruptedException | PublicKeyUnavailableException
	...
	{
		return new IPAddress(this.peer.getPeerID(), this.peer.getPeerName(), this.peer.getPeerIP(), this.peer.getPort());
	}
	...
	{
		log.info("removePartner is executed ...");
...
//		this.peer.addPartners(peerKey, peerName, ip, port);
	...
	{
		log.info("removeClient is executed ...");
...
//				return ((PublicCryptoSessionResponse)this.peer.read(ip.getIP(), ip.getPort(), new PublicCryptoSessionRequest(new PublicCrypto(crypto.getSessionKey(), this.peer.getPeerID(), crypto.getAsymAlgorithm(), crypto.getPublicKey()), crypto.getSymCrypto()))).isDone();
	...
	*/
	...
	public synchronized void inviteSymPartner(String partnerName) throws ClassNotFoundException, RemoteReadException, DistributedNodeFailedException, CryptographyMismatchException, NoSuchAlgorithmException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (!this.isAsymCryptography.get())
		{
			log.info("Inviting (Sym): " + partnerName);
			String peerKey = PeerContainer.getPeerKey(partnerName);
			if (!ServiceProvider.CRY().isSymmetricKeyExisted(peerKey))
			{
				log.info("Symmetric key is not existed ...");
//				IPAddress ip = this.getIPAddress(peerKey);
				IPAddress ip = this.getIPAddress(partnerName);
				if (ip != null)
				{
					log.info("partner's IP = " + ip);
...
//						ServiceProvider.CRY().retainSymmetricCrypto(symCrypto);
			...
			{
				log.info("Symmetric key is existed ...");
			}
		}
		else
		{
	...
	public synchronized void inviteAsymPartner(String partnerName) throws NoSuchAlgorithmException, ClassNotFoundException, RemoteReadException, InvalidKeyException, SignatureException, DistributedNodeFailedException, CryptographyMismatchException, RemoteIPNotExistedException, IOException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			log.info("Inviting (Asym): " + partnerName);
//			AsymmetricCrypto crypto = AsymmetricCoder.generateCrypto(this.asymCipherAlgorithm, this.asymCipherKeyLength, SymmetricCoder.generateCrypto(this.symCipherAlgorithm, this.symCipherSpec, this.symCipherKeyLength, this.symIVKeyLength));
//			AsymmetricCrypto crypto = AsymmetricCoder.generateCrypto(this.asymCipherAlgorithm, this.asymCipherKeyLength, this.symCipherAlgorithm, this.symCipherSpec, this.symCipherKeyLength, this.symIVKeyLength);
//			ServiceProvider.CRY().reset(crypto);
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//					return ((PublicCryptoSessionResponse)this.peer.read(ip.getIP(), ip.getPort(), new PublicCryptoSessionRequest(this.peer.getPeerName(), new PublicCrypto(ServiceProvider.CRY().getAsymmetricSessionKey(), this.peer.getPeerID(), ServiceProvider.CRY().getAsymmetricAlgorithm(), ServiceProvider.CRY().getPublicKey())))).isDone();
	...
	private void syncNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InterruptedException, DistributedNodeFailedException, RemoteIPNotExistedException, PeerNameIsNullException
	{
//		String peerKey = PeerContainer.getPeerKey(partnerName);
//		IPAddress ip = this.getIPAddress(peerKey);
		IPAddress ip = this.getIPAddress(partnerName);
	...
	private void asyncNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InterruptedException, DistributedNodeFailedException, RemoteIPNotExistedException, PeerNameIsNullException
	{
//		String peerKey = PeerContainer.getPeerKey(partnerName);
//		IPAddress ip = this.getIPAddress(peerKey);
		IPAddress ip = this.getIPAddress(partnerName);
...
//	private void syncNotifyByIPKey(String ipKey, Notification notification) throws IOException
	private void syncIPKNotify(String ipKey, ServerMessage notification) throws IOException
	{
		this.peer.syncNotify(ipKey, notification);
	}

	/*
	public void syncNotify(IPResource ip, Notification notification) throws IOException, InterruptedException
	{
		this.peer.syncNotify(ip.getIP(), ip.getPort(), notification);
	}
	*/
	...
	/*
	public void syncNotify(String ip, int port, Notification notification) throws IOException, InterruptedException
	{
	...
	*/
	...
	private void asyncNotify(String ip, int port, ServerMessage notification)
	{
		this.peer.asyncNotify(ip, port, notification);
	}

	private void syncSymNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, CryptographyMismatchException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, DistributedNodeFailedException, SymmetricKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//					this.peer.syncNotify(ip.getIP(), ip.getPort(), new EncryptedNotification(CryAppID.SYMMETRIC_ENCRYPTED_NOTIFICATION, symCrypto.getSessionKey(), enData));
	...
	private void asyncSymNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, CryptographyMismatchException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, DistributedNodeFailedException, SymmetricKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
	...
	/*
	public void syncSymNotify(String partnerName, ServerMessage notification) throws ClassNotFoundException, RemoteReadException, IOException, CryptographyMismatchException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, DistributedNodeFailedException, SymmetricKeyUnavailableException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//	private void syncNotifySymmetricallyByIPKey(String ipKey, Notification notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	private void syncSymIPKNotify(String partnerName, String ipKey, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
...
//					this.peer.syncNotify(ip.getIP(), ip.getPort(), new EncryptedNotification(CryAppID.SYMMETRIC_ENCRYPTED_NOTIFICATION, symCrypto.getSessionKey(), enData));
	...
	private void syncSymPrmNotify(String partnerName, String ipKey, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
	...
	/*
	public void syncSymNotify(IPResource ip, Notification notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
...
//				this.peer.syncNotify(ip.getIP(), ip.getPort(), new EncryptedNotification(CryAppID.SYMMETRIC_ENCRYPTED_NOTIFICATION, symCrypto.getSessionKey(), enData));
	...
	*/
	...
	/*
	public void syncSymNotify(IPResource ip, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(ip.getObjectKey());
...
//	private void syncNotifySymmetricallyByIP(String ip, int port, Notification notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, CryptographyMismatchException
	private void syncSymNotify(String partnerName, String ip, int port, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
...
//				this.peer.syncNotify(ip, port, new EncryptedNotification(CryAppID.SYMMETRIC_ENCRYPTED_NOTIFICATION, symCrypto.getSessionKey(), enData));
	...
	private void asyncSymNotify(String partnerName, String ip, int port, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (symCrypto != null)
			{
				byte[] enData = SymmetricCoder.encryptMessage(notification, symCrypto.getCipherKey(), symCrypto.getIVKey(), symCrypto.getCipherSpec());
				log.info("Encrypted Notification: " + Hex.toHexString(enData));
				this.peer.asyncNotify(ip, port, new EncryptedNotification(CryAppID.SYMMETRIC_ENCRYPTED_NOTIFICATION, this.peer.getPeerID(), enData));
			}
			else
			{
				throw new SymmetricKeyUnavailableException(partnerName);
...
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (symCrypto != null)
			{
				byte[] enData = SymmetricCoder.encryptMessage(notification, symCrypto.getCipherKey(), symCrypto.getIVKey(), symCrypto.getCipherSpec());
				log.info("Encrypted Notification: " + Hex.toHexString(enData));
				this.peer.syncNotify(ip, port, new SymmetricPrimitiveNotification(this.peer.getPeerID(), enData));
			}
			else
			{
				throw new SymmetricKeyUnavailableException(partnerName);
	...
	private void asyncSymPrmNotify(String partnerName, String ip, int port, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (symCrypto != null)
			{
				byte[] enData = SymmetricCoder.encryptMessage(notification, symCrypto.getCipherKey(), symCrypto.getIVKey(), symCrypto.getCipherSpec());
				log.info("Encrypted Notification: " + Hex.toHexString(enData));
				this.peer.asyncNotify(ip, port, new SymmetricPrimitiveNotification(this.peer.getPeerID(), enData));
			}
			else
			{
				throw new SymmetricKeyUnavailableException(partnerName);
	...
	private void syncAsymNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//					this.peer.syncNotify(ip.getIP(), ip.getPort(), new EncryptedNotification(CryAppID.ASYMMETRIC_ENCRYPTED_NOTIFICATION, acrypto.getSessionKey(), enData));
	...
	private void asyncAsymNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
	...
	/*
	public void syncAsymNotify(String partnerName, ServerMessage notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//	private void syncNotifyAsymmetricallyByIPKey(String ipKey, Notification notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	private void syncAsymIPKNotify(String partnerName, String ipKey, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
...
//					byte[] enData = SymmetricCoder.encryptNotification(notification, scrypto.getCipherKey(), scrypto.getIVKey(), scrypto.getCipherSpec());
	...
	private void syncAsymPrmNotify(String partnerName, String ipKey, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
	...
	/*
	public void syncAsymNotifyByIP(IPResource ip, Notification notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(ip.getObjectKey());
...
//				SymmetricCrypto scrypto = SymmetricCoder.generateCrypto(this.symCipherAlgorithm, this.symCipherSpec, this.symCipherKeyLength, this.symIVKeyLength, this.peer.getPeerID());
	...
	*/
	...
	/*
	public void syncAsymNotify(IPResource ip, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(ip.getObjectKey());
...
//	private void syncNotifyAsymmetricallyByIP(String ip, int port, Notification notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	private void syncAsymNotify(String partnerName, String ip, int port, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
...
//				byte[] enData = SymmetricCoder.encryptNotification(notification, scrypto.getCipherKey(), scrypto.getIVKey(), scrypto.getCipherSpec());
	...
	private void asyncAsymNotify(String partnerName, String ip, int port, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (publicKey != null)
			{
				...
				log.info("Encrypted Notification: " + Hex.toHexString(enData));
				byte[] enScrypto = AsymmetricCoder.encrypt(scrypto, publicKey.getAsymAlgorithm(), publicKey.getPublicKey());
				this.peer.asyncNotify(ip, port, new AsymmetricEncryptedNotification(publicKey.getSessionKey(), enData, enScrypto));
			}
			else
			{
				log.info("Public key is not found!");
	...
	private void syncAsymPrmNotify(String partnerName, String ip, int port, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (publicKey != null)
			{
				...
				log.info("Encrypted Notification: " + Hex.toHexString(enData));
				byte[] enScrypto = AsymmetricCoder.encrypt(scrypto, publicKey.getAsymAlgorithm(), publicKey.getPublicKey());
				this.peer.syncNotify(ip, port, new AsymmetricPrimitiveNotification(publicKey.getSessionKey(), enData, enScrypto));
			}
			else
			{
				log.info("Public key is not found!");
	...
	private void asyncAsymPrmNotify(String partnerName, String ip, int port, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (publicKey != null)
			{
				...
				log.info("Encrypted Notification: " + Hex.toHexString(enData));
				byte[] enScrypto = AsymmetricCoder.encrypt(scrypto, publicKey.getAsymAlgorithm(), publicKey.getPublicKey());
				this.peer.asyncNotify(ip, port, new AsymmetricPrimitiveNotification(publicKey.getSessionKey(), enData, enScrypto));
			}
			else
			{
				log.info("Public key is not found!");
	...
	*/
	...
	private void syncSignedNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
//		if (this.isAsymCryptography)
		if (this.isSigned())
		{
...
//					SymmetricCrypto scrypto = SymmetricCoder.generateCrypto(this.symCipherAlgorithm, this.symCipherSpec, this.symCipherKeyLength, this.symIVKeyLength, this.peer.getPeerID());
	...
	private void asyncSignedNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isSigned())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
	...
	/*
	public void syncSignedNotify(String partnerName, ServerMessage notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//	private void syncNotifyBySignatureByIPKey(String ipKey, Notification notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	private void syncSignedIPKNotify(String partnerName, String ipKey, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
...
//					byte[] enData = SymmetricCoder.encryptNotification(notification, scrypto.getCipherKey(), scrypto.getIVKey(), scrypto.getCipherSpec());
	...
	private void syncSignedPrmNotify(String partnerName, String ipKey, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
...
//	private void syncNotifyBySignatureByIP(String ip, int port, Notification notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	private void syncSignedNotify(String partnerName, String ip, int port, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
...
//				SymmetricCrypto scrypto = SymmetricCoder.generateCrypto(this.symCipherAlgorithm, this.symCipherSpec, this.symCipherKeyLength, this.symIVKeyLength, this.peer.getPeerID());
	...
	private void asyncSignedNotify(String partnerName, String ip, int port, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (publicKey != null)
			{
				...
				byte[] signedInfo = AsymmetricCoder.sign(ServiceProvider.CRY().getSignatureAlgorithm(), ServiceProvider.CRY().getPrivateKey(), ServiceProvider.CRY().getSignature());
				log.info("Your signature is " + ServiceProvider.CRY().getSignature());
				this.peer.asyncNotify(ip, port, new SignedAsymmetricEncryptedNotification(publicKey.getSessionKey(), enData, enScrypto, ServiceProvider.CRY().getSignature(), signedInfo));
			}
			else
			{
				log.info("Public key is not found!");
	...
	private void syncSignedPrmNotify(String partnerName, String ip, int port, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (publicKey != null)
			{
				...
				byte[] signedInfo = AsymmetricCoder.sign(ServiceProvider.CRY().getSignatureAlgorithm(), ServiceProvider.CRY().getPrivateKey(), ServiceProvider.CRY().getSignature());
				log.info("Your signature is " + ServiceProvider.CRY().getSignature());
				this.peer.syncNotify(ip, port, new SignedPrimitiveNotification(publicKey.getSessionKey(), enData, enScrypto, ServiceProvider.CRY().getSignature(), signedInfo));
			}
			else
			{
				log.info("Public key is not found!");
	...
	private void asyncSignedPrmNotify(String partnerName, String ip, int port, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
//			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
			...
			if (publicKey != null)
			{
				...
				byte[] signedInfo = AsymmetricCoder.sign(ServiceProvider.CRY().getSignatureAlgorithm(), ServiceProvider.CRY().getPrivateKey(), ServiceProvider.CRY().getSignature());
				log.info("Your signature is " + ServiceProvider.CRY().getSignature());
				this.peer.asyncNotify(ip, port, new SignedPrimitiveNotification(publicKey.getSessionKey(), enData, enScrypto, ServiceProvider.CRY().getSignature(), signedInfo));
			}
			else
			{
				log.info("Public key is not found!");
	...
	public void syncPrvNotify(String ownerName, String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//					this.peer.syncNotify(ip.getIP(), ip.getPort(), new SignedAsymmetricEncryptedNotification(publicKey.getSessionKey(), enData, enScrypto, ServiceProvider.CRY().getSignature(), signedInfo, ownerName));
	...
	public void syncPrvNotify(String ownerName, String partnerName, ServerMessage notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//		IPAddress ip = this.getIPAddress(peerKey);
	...
	*/
	...
	/*
	public void asyncSymNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, CryptographyMismatchException, DistributedNodeFailedException, SymmetricKeyUnavailableException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//					byte[] enData = SymmetricCoder.encryptMessage(notification, symCrypto.getCipherKey(), symCrypto.getIVKey(), symCrypto.getCipherSpec());
	...
	*/
	...
	/*
	public void asyncSymNotify(String partnerName, ServerMessage notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, CryptographyMismatchException, DistributedNodeFailedException, SymmetricKeyUnavailableException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
//			IPAddress ip = this.getIPAddress(peerKey);
			...
			if (ip != null)
			{
				...
				if (symCrypto != null)
				{
					byte[] enData = SymmetricCoder.encryptMessage(notification, symCrypto.getCipherKey(), symCrypto.getIVKey(), symCrypto.getCipherSpec());
					log.info("Encrypted Notification: " + Hex.toHexString(enData));
					this.peer.asyncNotify(ip.getIP(), ip.getPort(), new SymmetricPrimitiveNotification(this.peer.getPeerID(), enData));
				}
				else
				{
					throw new SymmetricKeyUnavailableException(partnerName);
	...
	*/
	...
	/*
	public void asyncAsymNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//					this.peer.asyncNotify(ip.getIP(), ip.getPort(), new EncryptedNotification(CryAppID.ASYMMETRIC_ENCRYPTED_NOTIFICATION, crypto.getSessionKey(), enData));
	...
	*/
	...
	/*
	public void asyncAsymNotify(String partnerName, ServerMessage notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
			...
			if (ip != null)
			{
				...
				if (publicKey != null)
				{
					...
					byte[] enData = SymmetricCoder.encryptMessage(notification, scrypto.getCipherKey(), scrypto.getIVKey(), scrypto.getCipherSpec());
					byte[] enScrypto = AsymmetricCoder.encrypt(scrypto, publicKey.getAsymAlgorithm(), publicKey.getPublicKey());
					this.peer.asyncNotify(ip.getIP(), ip.getPort(), new AsymmetricPrimitiveNotification(publicKey.getSessionKey(), enData, enScrypto));
				}
				else
				{
					log.info("Public key is not found!");
	...
	*/
	...
	/*
	public void asyncSignedNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
//		if (this.isAsymCryptography)
		if (this.isSigned())
		{
...
//					SymmetricCrypto scrypto = SymmetricCoder.generateCrypto(this.symCipherAlgorithm, this.symCipherSpec, this.symCipherKeyLength, this.symIVKeyLength, this.peer.getPeerID());
	...
	*/
	...
	/*
	public void asyncSignedNotify(String partnerName, ServerMessage notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
			...
			if (ip != null)
			{
				...
				if (publicKey != null)
				{
					...
					byte[] signedInfo = AsymmetricCoder.sign(ServiceProvider.CRY().getSignatureAlgorithm(), ServiceProvider.CRY().getPrivateKey(), ServiceProvider.CRY().getSignature());
					log.info("Your signature is " + ServiceProvider.CRY().getSignature());
					this.peer.asyncNotify(ip.getIP(), ip.getPort(), new SignedPrimitiveNotification(publicKey.getSessionKey(), enData, enScrypto, ServiceProvider.CRY().getSignature(), signedInfo));
				}
				else
				{
					log.info("Public key is not found!");
	...
	*/
	...
	public void asyncPrvNotify(String ownerName, String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//					this.peer.asyncNotify(ip.getIP(), ip.getPort(), new SignedAsymmetricEncryptedNotification(publicKey.getSessionKey(), enData, enScrypto, ServiceProvider.CRY().getSignature(), signedInfo, ownerName));
	...
	public void asyncPrvNotify(String ownerName, String partnerName, ServerMessage notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
			...
			if (ip != null)
			{
				...
				if (publicKey != null)
				{
					...
					byte[] signedInfo = AsymmetricCoder.sign(ServiceProvider.CRY().getSignatureAlgorithm(), ServiceProvider.CRY().getPrivateKey(), ServiceProvider.CRY().getSignature());
					log.info("Your signature is " + ServiceProvider.CRY().getSignature());
					this.peer.asyncNotify(ip.getIP(), ip.getPort(), new PrivatePrimitiveNotification(publicKey.getSessionKey(), enData, enScrypto, ServiceProvider.CRY().getSignature(), signedInfo, ownerName));
				}
				else
				{
					log.info("Public key is not found!");
	...
	private ServerMessage read(String partnerName, Request request) throws ClassNotFoundException, RemoteReadException, DistributedNodeFailedException, RemoteIPNotExistedException, PeerNameIsNullException
	{
//		String peerKey = PeerContainer.getPeerKey(partnerName);
//		IPAddress ip = this.getIPAddress(peerKey);
		IPAddress ip = this.getIPAddress(partnerName);
	...
	private ServerMessage symRead(String partnerName, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, ShortBufferException, CryptographyMismatchException, DistributedNodeFailedException, SymmetricKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//					EncryptedResponse response = (EncryptedResponse)this.peer.read(ip.getIP(), ip.getPort(), new EncryptedRequest(CryAppID.SYMMETRIC_ENCRYPTED_REQUEST, symCrypto.getSessionKey(), enData));
	...
	private ServerMessage symRead(String partnerName, String ip, int port, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, ShortBufferException, CryptographyMismatchException, DistributedNodeFailedException, SymmetricKeyUnavailableException, RemoteIPNotExistedException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
			...
			if (symCrypto != null)
			{
				byte[] enData = SymmetricCoder.encryptRequest(request, symCrypto.getCipherKey(), symCrypto.getIVKey(), symCrypto.getCipherSpec());
				log.info("Encrypted Request: " + Hex.toHexString(enData));
				EncryptedResponse response = (EncryptedResponse)this.peer.read(ip, port, new EncryptedRequest(CryAppID.SYMMETRIC_ENCRYPTED_REQUEST, this.peer.getPeerID(), enData));
				if (response != null)
				{
					log.info("Encrypted Response: " + Hex.toHexString(response.getEncryptedData()));
					return SymmetricCoder.decryptResponse(response.getEncryptedData(), symCrypto.getCipherKey(), symCrypto.getIVKey(), symCrypto.getCipherSpec());
	...
	private ServerMessage symRead(String partnerName, String ip, int port, ServerMessage request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, ShortBufferException, CryptographyMismatchException, DistributedNodeFailedException, SymmetricKeyUnavailableException, RemoteIPNotExistedException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
	...
	private ServerMessage asymRead(String partnerName, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, ShortBufferException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//						return AsymmetricCoder.decryptResponse(response.getEncryptedData(), ServiceProvider.CRY().getAsymmetricAlgorithm(), ServiceProvider.CRY().getPrivateKey());
	...
	private ServerMessage asymRead(String partnerName, String ip, int port, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, ShortBufferException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException, RemoteIPNotExistedException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
			...
			if (publicKey != null)
			{
				...
				byte[] enScrypto = AsymmetricCoder.encrypt(scrypto, publicKey.getAsymAlgorithm(), publicKey.getPublicKey());
				log.info("Encrypted Request: " + Hex.toHexString(enData));
				AsymmetricEncryptedResponse response = (AsymmetricEncryptedResponse)this.peer.read(ip, port, new AsymmetricEncryptedRequest(publicKey.getSessionKey(), enData, enScrypto));
				if (response != null)
				{
					log.info("Encrypted Response: " + Hex.toHexString(response.getEncryptedData()));
					SymmetricCrypto resScrypto = (SymmetricCrypto)AsymmetricCoder.decrypt(response.getEncryptedSymCrypto(), ServiceProvider.CRY().getAsymmetricAlgorithm(), ServiceProvider.CRY().getPrivateKey());
	...
	private ServerMessage signedRead(String partnerName, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, ShortBufferException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, OwnerCheatingException, CheatingException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
//		if (this.isAsymCryptography)
		if (this.isSigned())
		{
...
//		log.info("Last: response is null in Peer ...");
	...
	private ServerMessage signedRead(String partnerName, String ip, int port, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, ShortBufferException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, OwnerCheatingException, CheatingException, PublicKeyUnavailableException, RemoteIPNotExistedException
	{
		if (this.isSigned())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
			...
			if (publicKey != null)
			{
				...
				log.info("Your signature is " + ServiceProvider.CRY().getSignature());
				log.info("Encrypted Request: " + Hex.toHexString(enData));
				SignedAsymmetricEncryptedResponse response = (SignedAsymmetricEncryptedResponse)this.peer.read(ip, port, new SignedAsymmetricEncryptedRequest(publicKey.getSessionKey(), enData, enScrypto, ServiceProvider.CRY().getSignature(), signedInfo));
				if (response != null)
				{
					if (ServiceProvider.CRY().isSignatureTrusted(response.getSignature(), response.getEncryptedSignature(), false))
					{
				...
				{
//						log.info("response is null in Peer ...");
//					throw new NoResponseException(ip, port);
				}
			}
			else
			{
...
//		log.info("Last: response is null in Peer ...");
	...
	private ServerMessage signedRead(String partnerName, String ip, int port, ServerMessage request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, ShortBufferException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, OwnerCheatingException, CheatingException, PublicKeyUnavailableException, RemoteIPNotExistedException
	{
		if (this.isSigned())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//							return (Boolean)SymmetricCoder.decryptObject(response.getEncryptedData(), resScrypto.getCipherKey(), resScrypto.getIVKey(), resScrypto.getCipherSpec());
	...
	public ServerMessage prvRead(String ownerName, String partnerName, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, ShortBufferException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, OwnerCheatingException, CheatingException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//	public IPAddress getIPAddress(String peerKey) throws ClassNotFoundException, RemoteReadException, IOException
	public IPAddress getIPAddress(String peerName) throws ClassNotFoundException, RemoteReadException, RemoteIPNotExistedException
	{
	...
	*/
	...
	public void syncCryNotify(String peerName, Notification notification, int cryptoOption) throws ClassNotFoundException, RemoteReadException, IOException, InterruptedException, DistributedNodeFailedException, NoSuchAlgorithmException, CryptographyMismatchException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, SignatureException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
			...
			case MulticastConfig.SYM:
				...
				this.syncSymNotify(peerName, notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.syncAsymNotify(peerName, notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.syncSignedNotify(peerName, notification);
				break;
		}
	}

	public void asyncCryNotify(String peerName, Notification notification, int cryptoOption) throws ClassNotFoundException, RemoteReadException, IOException, InterruptedException, DistributedNodeFailedException, NoSuchAlgorithmException, CryptographyMismatchException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, SignatureException, PublicKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
				this.asyncNotify(peerName, notification);
				break;
			...
			case MulticastConfig.SYM:
				...
				this.asyncSymNotify(peerName, notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.asyncAsymNotify(peerName, notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.asyncSignedNotify(peerName, notification);
				break;
		}
	}

	public ServerMessage cryRead(String peerName, Request request, int cryptoOption) throws ClassNotFoundException, RemoteReadException, IOException, InterruptedException, DistributedNodeFailedException, NoSuchAlgorithmException, CryptographyMismatchException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, SignatureException, PublicKeyUnavailableException, ShortBufferException, OwnerCheatingException, CheatingException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
			...
			case MulticastConfig.SYM:
				...
				return this.symRead(peerName, request);
			...
			case MulticastConfig.ASYM:
				...
				return this.asymRead(peerName, request);
			...
			case MulticastConfig.SIGNED:
				...
				return this.signedRead(peerName, request);
		}
		return null;
	}

	public ServerMessage cryRead(String peerName, String ip, int port, Request request, int cryptoOption) throws ClassNotFoundException, RemoteReadException, IOException, InterruptedException, DistributedNodeFailedException, NoSuchAlgorithmException, CryptographyMismatchException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, SignatureException, PublicKeyUnavailableException, ShortBufferException, OwnerCheatingException, CheatingException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
			...
			case MulticastConfig.SYM:
				...
				return this.symRead(peerName, ip, port, request);
			...
			case MulticastConfig.ASYM:
				...
				return this.asymRead(peerName, ip, port, request);
			...
			case MulticastConfig.SIGNED:
				...
				return this.signedRead(peerName, ip, port, request);
		}
		return null;
	}

	public ServerMessage cryRead(String peerName, String ip, int port, ServerMessage request, int cryptoOption) throws ClassNotFoundException, RemoteReadException, IOException, InterruptedException, DistributedNodeFailedException, NoSuchAlgorithmException, CryptographyMismatchException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, SignatureException, PublicKeyUnavailableException, ShortBufferException, OwnerCheatingException, CheatingException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
...
//	public void syncCryptoNotifyByIP(String peerName, IPAddress ip, Notification notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException
	public void syncCryNotify(String peerName, IPAddress ip, ServerMessage notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
				this.syncNotify(ip.getIP(), ip.getPort(), notification);
				break;
			...
			case MulticastConfig.SYM:
				...
				this.syncSymNotify(peerName, ip.getIP(), ip.getPort(), notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.syncAsymNotify(peerName, ip.getIP(), ip.getPort(), notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.syncSignedNotify(peerName, ip.getIP(), ip.getPort(), notification);
				break;
		}
	}

	public void asyncCryNotify(String peerName, IPAddress ip, ServerMessage notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
				this.asyncNotify(ip.getIP(), ip.getPort(), notification);
				break;
			...
			case MulticastConfig.SYM:
				...
				this.asyncSymNotify(peerName, ip.getIP(), ip.getPort(), notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.asyncAsymNotify(peerName, ip.getIP(), ip.getPort(), notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.asyncSignedNotify(peerName, ip.getIP(), ip.getPort(), notification);
				break;
		}
	}

//	public void syncCryptoNotifyByIP(String peerName, String ip, int port, Notification notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException
	public void syncCryNotify(String peerName, String ip, int port, ServerMessage notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
				this.syncNotify(ip, port, notification);
				break;
			...
			case MulticastConfig.SYM:
				...
				this.syncSymNotify(peerName, ip, port, notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.syncAsymNotify(peerName, ip, port, notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.syncSignedNotify(peerName, ip, port, notification);
				break;
		}
	}

	public void syncCryPrmNotify(String peerName, String ip, int port, ServerMessage notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
			...
			case MulticastConfig.SYM:
				...
				this.syncSymPrmNotify(peerName, ip, port, notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.syncAsymPrmNotify(peerName, ip, port, notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.syncSignedPrmNotify(peerName, ip, port, notification);
				break;
		}
	}
	
	public void asyncCryPrmNotify(String peerName, String ip, int port, ServerMessage notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		switch (cryptoOption)
		{
			case MulticastConfig.PLAIN:
				this.asyncNotify(ip, port, notification);
				break;
			...
			case MulticastConfig.SYM:
				...
				this.asyncSymPrmNotify(peerName, ip, port, notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.asyncAsymPrmNotify(peerName, ip, port, notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.asyncSignedPrmNotify(peerName, ip, port, notification);
				break;
		}
	}
...
//	public void syncCryptoNotifyByIPKey(String ipKey, Notification notification, int cryptoOption) throws ClassNotFoundException, NoSuchAlgorithmException, RemoteReadException, DistributedNodeFailedException, CryptographyMismatchException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, SymmetricKeyUnavailableException, SignatureException, PublicKeyUnavailableException, IOException
	public void syncCryNotify(String ipKey, ServerMessage notification, int cryptoOption) throws ClassNotFoundException, NoSuchAlgorithmException, RemoteReadException, DistributedNodeFailedException, CryptographyMismatchException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, SymmetricKeyUnavailableException, SignatureException, PublicKeyUnavailableException, IOException, RemoteIPNotExistedException, PeerNameIsNullException, IPNotExistedException
	{
		try
		{
			...
			{
				case MulticastConfig.PLAIN:
					this.syncIPKNotify(ipKey, notification);
					break;
				...
				case MulticastConfig.SYM:
					...
					this.syncSymIPKNotify(partnerName, ipKey, notification);
					break;
				...
				case MulticastConfig.ASYM:
					...
					this.syncAsymIPKNotify(partnerName, ipKey, notification);
					break;
				...
				case MulticastConfig.SIGNED:
					...
					this.syncSignedIPKNotify(partnerName, ipKey, notification);
					break;
			}
		}
		catch (IOException e)
	...
	public void syncCryPrmNotify(String ipKey, ServerMessage notification, int cryptoOption) throws ClassNotFoundException, NoSuchAlgorithmException, RemoteReadException, DistributedNodeFailedException, CryptographyMismatchException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, SymmetricKeyUnavailableException, SignatureException, PublicKeyUnavailableException, IOException, RemoteIPNotExistedException, PeerNameIsNullException, IPNotExistedException
	{
		try
		{
			String partnerName;
			switch (cryptoOption)
			{
				...
				case MulticastConfig.SYM:
					...
					this.syncSymPrmNotify(partnerName, ipKey, notification);
					break;
				...
				case MulticastConfig.ASYM:
					...
					this.syncAsymPrmNotify(partnerName, ipKey, notification);
					break;
				...
				case MulticastConfig.SIGNED:
					...
					this.syncSignedPrmNotify(partnerName, ipKey, notification);
					break;
			}
		}
		catch (IOException e)
	...
	private void syncAsymBye(String partnerName, AsymmetricBye bye) throws ClassNotFoundException, RemoteReadException, IOException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		String peerKey = PeerContainer.getPeerKey(partnerName);
		IPAddress ip = this.getIPAddress(partnerName);
		if (ip != null)
...
//				SymmetricCrypto scrypto = SymmetricCoder.generateCrypto(this.symCipherAlgorithm, this.symCipherSpec, this.symCipherKeyLength, this.symIVKeyLength, this.peer.getPeerID());
	...
	private void syncSymBye(String partnerName, SymmetricBye bye) throws ClassNotFoundException, RemoteReadException, IOException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, SymmetricKeyUnavailableException, RemoteIPNotExistedException, PeerNameIsNullException
	{
		String peerKey = PeerContainer.getPeerKey(partnerName);
		IPAddress ip = this.getIPAddress(partnerName);
		if (ip != null)
