		...
		while (!super.isShutdown())
		{
			while (!super.isEmpty())
			{
				try
				{
					...
					ServiceProvider.CRY().processClusterRootSymmetricNotification(super.getServerKey(), notification);
				...
				catch (InterruptedException | InvalidKeyException | NoSuchAlgorithmException | NoSuchPaddingException | InvalidAlgorithmParameterException | ShortBufferException | IllegalBlockSizeException | BadPaddingException | ClassNotFoundException | IOException e)
				{
					e.printStackTrace();
				}
			}
