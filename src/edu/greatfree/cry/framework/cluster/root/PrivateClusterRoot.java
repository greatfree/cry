 ...
 *
 */
final class PrivateClusterRoot
{
	private ClusterServerContainer server;

	private PrivateClusterRoot()
	{
	}
	
	private static PrivateClusterRoot instance = new PrivateClusterRoot();
	
	public static PrivateClusterRoot CRY()
	{
		if (instance == null)
		{
			instance = new PrivateClusterRoot();
			return instance;
		}
		else
		{
