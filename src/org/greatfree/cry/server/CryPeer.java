...
//	private void syncNotifyByIPKey(String ipKey, Notification notification) throws IOException
	...
	public void syncSymNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, CryptographyMismatchException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, InterruptedException, DistributedNodeFailedException, SymmetricKeyUnavailableException
	{
		if (!this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//	private void syncNotifySymmetricallyByIPKey(String ipKey, Notification notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	private void syncSymIPKNotify(String ipKey, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
...
//					this.peer.syncNotify(ip.getIP(), ip.getPort(), new EncryptedNotification(CryAppID.SYMMETRIC_ENCRYPTED_NOTIFICATION, symCrypto.getSessionKey(), enData));
	...
	private void syncSymPrmNotify(String ipKey, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
...
//	private void syncNotifySymmetricallyByIP(String ip, int port, Notification notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, CryptographyMismatchException
	private void syncSymNotify(String ip, int port, ServerMessage notification) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, SymmetricKeyUnavailableException, CryptographyMismatchException
	{
		if (!this.isAsymCryptography.get())
		{
...
//				this.peer.syncNotify(ip, port, new EncryptedNotification(CryAppID.SYMMETRIC_ENCRYPTED_NOTIFICATION, symCrypto.getSessionKey(), enData));
	...
	public void syncAsymNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//	private void syncNotifyAsymmetricallyByIPKey(String ipKey, Notification notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	private void syncAsymIPKNotify(String ipKey, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
...
//					byte[] enData = SymmetricCoder.encryptNotification(notification, scrypto.getCipherKey(), scrypto.getIVKey(), scrypto.getCipherSpec());
	...
	private void syncAsymPrmNotify(String ipKey, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
...
//	private void syncNotifyAsymmetricallyByIP(String ip, int port, Notification notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	private void syncAsymNotify(String ip, int port, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
...
//				byte[] enData = SymmetricCoder.encryptNotification(notification, scrypto.getCipherKey(), scrypto.getIVKey(), scrypto.getCipherSpec());
	...
	private void syncAsymPrmNotify(String ip, int port, ServerMessage notification) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, InterruptedException, PublicKeyUnavailableException, DistributedNodeFailedException, CryptographyMismatchException
	{
		if (this.isAsymCryptography.get())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
	...
	*/
	...
	public void syncSignedNotify(String partnerName, Notification notification) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InterruptedException, InvalidAlgorithmParameterException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
//		if (this.isAsymCryptography)
		if (this.isSigned())
		{
...
//	private void syncNotifyBySignatureByIPKey(String ipKey, Notification notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	private void syncSignedIPKNotify(String ipKey, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
...
//					byte[] enData = SymmetricCoder.encryptNotification(notification, scrypto.getCipherKey(), scrypto.getIVKey(), scrypto.getCipherSpec());
	...
	private void syncSignedPrmNotify(String ipKey, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(ipKey);
...
//	private void syncNotifyBySignatureByIP(String ip, int port, Notification notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	private void syncSignedNotify(String ip, int port, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
...
//				SymmetricCrypto scrypto = SymmetricCoder.generateCrypto(this.symCipherAlgorithm, this.symCipherSpec, this.symCipherKeyLength, this.symIVKeyLength, this.peer.getPeerID());
	...
	private void syncSignedPrmNotify(String ip, int port, ServerMessage notification) throws CryptographyMismatchException, DistributedNodeFailedException, NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, SignatureException, InterruptedException, PublicKeyUnavailableException
	{
		if (this.isSigned())
		{
			String partnerName = ServiceProvider.CRY().getPartnerName(Tools.getKeyOfFreeClient(ip, port));
...
//					EncryptedResponse response = (EncryptedResponse)this.peer.read(ip.getIP(), ip.getPort(), new EncryptedRequest(CryAppID.SYMMETRIC_ENCRYPTED_REQUEST, symCrypto.getSessionKey(), enData));
	...
	public ServerMessage asymRead(String partnerName, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, ShortBufferException, CryptographyMismatchException, DistributedNodeFailedException, PublicKeyUnavailableException
	{
		if (this.isAsymCryptography.get())
		{
			String peerKey = PeerContainer.getPeerKey(partnerName);
...
//						return AsymmetricCoder.decryptResponse(response.getEncryptedData(), ServiceProvider.CRY().getAsymmetricAlgorithm(), ServiceProvider.CRY().getPrivateKey());
	...
	public ServerMessage signedRead(String partnerName, Request request) throws ClassNotFoundException, RemoteReadException, IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException, ShortBufferException, SignatureException, CryptographyMismatchException, DistributedNodeFailedException, OwnerCheatingException, CheatingException, PublicKeyUnavailableException
	{
//		if (this.isAsymCryptography)
		if (this.isSigned())
		{
	...
	public void syncCryNotify(String peerName, IPAddress ip, ServerMessage notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException
	{
		switch (cryptoOption)
		{
			...
			case MulticastConfig.SYM:
				...
				this.syncSymNotify(ip.getIP(), ip.getPort(), notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.syncAsymNotify(ip.getIP(), ip.getPort(), notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.syncSignedNotify(ip.getIP(), ip.getPort(), notification);
				break;
		}
	}
	...
	public void syncCryNotify(String peerName, String ip, int port, ServerMessage notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException
	{
		switch (cryptoOption)
		{
			...
			case MulticastConfig.SYM:
				...
				this.syncSymNotify(ip, port, notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.syncAsymNotify(ip, port, notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.syncSignedNotify(ip, port, notification);
				break;
		}
	}
	...
	public void syncCryPrmNotify(String peerName, String ip, int port, ServerMessage notification, int cryptoOption) throws IOException, InterruptedException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, SymmetricKeyUnavailableException, CryptographyMismatchException, PublicKeyUnavailableException, DistributedNodeFailedException, SignatureException, ClassNotFoundException, RemoteReadException
	{
		switch (cryptoOption)
		{
			...
			case MulticastConfig.SYM:
				...
				this.syncSymPrmNotify(ip, port, notification);
				break;
			...
			case MulticastConfig.ASYM:
				...
				this.syncAsymPrmNotify(ip, port, notification);
				break;
			...
			case MulticastConfig.SIGNED:
				...
				this.syncSignedPrmNotify(ip, port, notification);
				break;
		}
	}
		...
		try
		{
			...
			switch (cryptoOption)
			{
				...
				case MulticastConfig.SYM:
					...
					this.syncSymIPKNotify(ipKey, notification);
					break;
				...
				case MulticastConfig.ASYM:
					...
					this.syncAsymIPKNotify(ipKey, notification);
					break;
				...
				case MulticastConfig.SIGNED:
					...
					this.syncSignedIPKNotify(ipKey, notification);
					break;
			}
		}
		catch (IOException e)
		...
		try
		{
			...
			switch (cryptoOption)
			{
				...
				case MulticastConfig.SYM:
					...
					this.syncSymPrmNotify(ipKey, notification);
					break;
				...
				case MulticastConfig.ASYM:
					...
					this.syncAsymPrmNotify(ipKey, notification);
					break;
				...
				case MulticastConfig.SIGNED:
					...
					this.syncSignedPrmNotify(ipKey, notification);
					break;
			}
		}
		catch (IOException e)
