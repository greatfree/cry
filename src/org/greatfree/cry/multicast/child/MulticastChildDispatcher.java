...
//			log.info("super.getServerKey() = " + super.getServerKey());
			this.multiNotifyDispatcher = new NotificationDispatcher.NotificationDispatcherBuilder<MulticastNotification, MulticastNotificationThread, MulticastNotificationThreadCreator>()
			...
			this.multiReqDispatcher = new NotificationDispatcher.NotificationDispatcherBuilder<MulticastRequest, MulticastRequestThread, MulticastRequestThreadCreator>()
					.serverKey(super.getServerKey())
					.poolSize(ServerConfig.NOTIFICATION_DISPATCHER_POOL_SIZE)
