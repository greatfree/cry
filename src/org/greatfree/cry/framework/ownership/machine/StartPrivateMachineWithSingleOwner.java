 ...
 *
 */
class StartPrivateMachineWithSingleOwner
{
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException, RemoteReadException
	{
		...
		/*
		 * The machine is private, and its owners' size is set to be 1. 03/22/2022, Bing Li
		 */
		Machine.RSC().start(machineName, OwnerConfig.MACHINE_PORT, OwnerConfig.REGISTRY_IP, OwnerConfig.REGISTRY_PORT, true, 1);
